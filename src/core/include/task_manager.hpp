...
//
//     using calendar_t = std::unordered_map<std::string, singulars_t>;
//
//   private:
//     static const inline auto
//     lookaheadDuration{hbt::mods::Interval::days(90)}; static const inline
//     auto retentionDuration{hbt::mods::Interval::days(7)};
//
//   private:
...
//
//   private:
//     [[nodiscard]] auto instantiateSeriesForDate(mods::DateTime datetime)
//     const
//         -> singulars_t;
//
//   public:
