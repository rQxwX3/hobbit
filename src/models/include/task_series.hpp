...
// class TaskSeries {
//   public:
//     using timestamps_t = util::RecurrencePattern::occurrences_t;
//
...
//     jsonRecurrenceField{std::string_view{"recurrence"}};
//
...
//
//   private:
//     [[nodiscard]] auto static containsAllJSONFields(const nlohmann::json
//     &json)
//         -> bool;
//
//   public:
