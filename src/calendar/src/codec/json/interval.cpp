...
[[nodiscard]] auto Interval::encode(const dt::Interval &interval)
    -> nlohmann::json {
    return {
        {getFieldName(Field::duration), ISO8601::Interval::encode(interval)},
...
[[nodiscard]] auto Interval::decode(const nlohmann::json &json)
    ...
    auto intervalFromISO8601{ISO8601::Interval::decode(
