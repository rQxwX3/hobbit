...
[[nodiscard]] auto SelectedWeekdays::contains(dt::constants::Weekday wd) const
    -> bool {
...
[[nodiscard]] auto SelectedWeekdays::isEmpty() const -> bool {
    return std::ranges::none_of(
        ...
        [this](const auto wd) -> bool { return this->contains(wd); });
}

auto SelectedWeekdays::add(dt::constants::Weekday wd) -> void {
    days_.set(static_cast<size_t>(wd));
}
} // namespace clndr::rec
